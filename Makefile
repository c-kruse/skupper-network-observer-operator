...
# skupper.io/skupper-network-observer-operator-bundle:$VERSION and skupper.io/skupper-network-observer-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/ckruse/skupper/network-observer-operator
